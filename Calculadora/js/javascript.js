...
document.getElementById("ts").addEventListener("click",showsuccess);

function n1() {
	let actual = document.getElementById('success').innerHTML;
	let sumado = document.getElementById("n1").innerHTML;
	document.getElementById('success').innerHTML = actual + sumado
}
function n2() {
	let actual = document.getElementById('success').innerHTML;
